...
class _ScoreboardPageState extends ScoreboardStateBase<ScoreboardPage> {
        ...
        return Dialog(
          ...
          child: SizedBox(
            ...
            child: ConstrainedBox(
              constraints:
              BoxConstraints(maxHeight: screenH * 0.75),
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('승/패 기준이 될 나의 팀을 선택하세요.',
                        style: TextStyle(
                            fontSize: 12,
  ...
  Widget _myTeamOption({
    ...
    final border =
    isWin ? const Color(0xFF1565C0) : const Color(0xFFD32F2F);
            ...
            child: Align(
              ...
              child: ConstrainedBox(
                constraints: BoxConstraints(
                    maxWidth:
                    media.size.width * maxWidthFactor,
                    maxHeight:
  ...
  Future<void> _openServeSetupSheet() async {
    ...
    final result =
    await _showResponsiveBottomSheet<ScoreboardServeSetupResult>(
      maxWidthFactor: 0.72,
                    ...
                    FilledButton(
                      onPressed: canConfirm
                          ...
                          ScoreboardServeSetupResult(
                              ...
                              opponentFirstServerGlobalIndex:
                              tempOpponent!))
                          : null,
                      child: const Text('확인'),
                    ),
  ...
  Future<void> _openTargetScoreSheet() async {
    ...
    final result =
    await _showResponsiveBottomSheet<Map<String, dynamic>>(
      maxWidthFactor: 0.55,
      child: StatefulBuilder(builder: (ctx, setLocal) {
        return Column(
            mainAxisSize: MainAxisSize.min,
        ...
        builder: (ctx) => AlertDialog(
          ...
          actions: [
            ...
            FilledButton(
                onPressed: () {
                  Navigator.pop(ctx);
                  Navigator.pop(context); // ← 메인앱으로 복귀
                },
                child: const Text('확인')),
          ],
        ));
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: LayoutBuilder(builder: (context, constraints) {
          ...
          (sw * 0.13).clamp(80.0, 120.0);
          final double centerGap =
          (sw * 0.012).clamp(6.0, 16.0);
          final double scoreGap =
          (sh * 0.015).clamp(4.0, 10.0);
          final double bottomRowH =
          (sh * 0.12).clamp(32.0, 50.0);
                        ...
                        SizedBox(
                          ...
                          child: BottomTextButton(
                            ...
                            borderColor: saveEnabled
                                ...
                                : Colors.white24,
                            onTap:
                            saveEnabled ? _onSaveTapped : null,
